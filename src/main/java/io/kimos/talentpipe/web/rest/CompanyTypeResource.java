...
import io.kimos.talentpipe.web.rest.dto.CreateCompanyTypeDTO;
import io.kimos.talentpipe.web.rest.dto.UpdateCompanyTypeDTO;
...
public class CompanyTypeResource {
    ...
    public CompanyTypeResource(CompanyTypeService companyTypeService, MapperFacade orikaMapper) {
