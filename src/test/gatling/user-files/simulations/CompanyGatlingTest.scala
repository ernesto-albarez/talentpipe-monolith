...
class CompanyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Company entity")
        ...
        .repeat(2) {
            ...
            .post("/api/companies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "taxName":"SAMPLE_TEXT", "taxId":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "street":"SAMPLE_TEXT", "floor":"0", "number":"0", "apartment":"SAMPLE_TEXT", "postalCode":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "contactName":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
