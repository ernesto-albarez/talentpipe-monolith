...
import io.kimos.talentppe.config.audit.AuditEventConverter;
import io.kimos.talentppe.domain.PersistentAuditEvent;
...
import static io.kimos.talentppe.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
